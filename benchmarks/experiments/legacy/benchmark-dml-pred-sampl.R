library(dplyr)
source("R/diff_marg_likelihood_pred_sampl.R")

set.seed(3405934)
method = "diff_marg_likelihood_pred_sampl"
...
for (iter in 1:N) {
  ...
  results_list <- diff_marg_likelihood_pred_sampl(labeled_data = labeled_data, 
...
path = paste(getwd(),"/results/diff_marg_likelihood_pred_sampl_",
