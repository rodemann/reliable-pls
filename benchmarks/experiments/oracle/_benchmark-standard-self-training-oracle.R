library(dplyr)
source("R/standard_self_training_oracle.R")

set.seed(3405934)
method = "standard_self_training_oracle"
...
for (iter in 1:N) {
  ...
  # create data setup by randomly unlabeling data points
  ...
  results_list <- standard_self_training_oracle(labeled_data = labeled_data, 
...
path = paste(getwd(),"/results/standard_self_oracle_",
