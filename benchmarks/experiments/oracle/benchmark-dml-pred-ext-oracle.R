library(dplyr)
source("R/diff_marg_likelihood_pred_ext_oracle.R")

set.seed(3405934)
method = "diff_marg_likelihood_pred_ext_oracle"
...
for (iter in 1:N) {
  ...
  results_list <- diff_marg_likelihood_pred_ext_oracle(labeled_data = labeled_data, 
...
path = paste(getwd(),"/results/diff_marg_likelihood_pred_ext_oracle_",
