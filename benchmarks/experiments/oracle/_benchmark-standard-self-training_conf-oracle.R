library(dplyr)
source("R/standard_self_training_conf_oracle.R")

set.seed(3405934)
method = "standard_self_training_conf_oracle"
...
for (iter in 1:N) {
  ...
  results_list <- standard_self_training_conf_oracle(labeled_data = labeled_data, 
...
path = paste(getwd(),"/results/standard_self_conf_oracle_",
